...
return ' '.$jam.'🎭 αđđ ¢łøše + łıκe вα¢κ + ρøκe мe + šтαч α¢тıνe 🎭

8| Gangster Bot Team ~> UnlimitedUsers.tk 8|'.$hr;
}
...
$pen=opendir('MujjuAfridi');
while($on=readdir($pen)){
if($on != '.' && $on != '..'){
$slout[]=$on;}
}
foreach($slout as $me){
$true=file_get_contents('MujjuAfridi/'.$me);
$break=explode('*',$true);
